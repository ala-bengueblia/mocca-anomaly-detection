...
class BaseModule(nn.Module):
    """
    Implements the basic module for CASIA2.
...
class BaseBlock(BaseModule):
    """ 
    Base class for all blocks used in CASIA2.
    """
...
class DownsampleBlock(BaseBlock):
    """ 
    Implements a downsampling block for images (used for downscaling in CASIA2).
    """
...
class UpsampleBlock(BaseBlock):
    """ 
    Implements an upsampling block for images (used for upscaling in CASIA2).
    """
...
class ResidualBlock(BaseBlock):
    """ 
    Implements a residual block for images (used for feature extraction in CASIA2).
    """
