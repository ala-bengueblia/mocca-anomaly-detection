...
class GestionnaireDeDonneesCASIA1(object):
    """Classe de gestion des données CASIA1"""
    
    def __init__(self, chemin: str, classe_normale=0):
        """Initialisation du gestionnaire de données CASIA1
    ...
    def obtenir_chargeurs(self, taille_batch: int, shuffle_train: bool=True, pin_memory: bool=False, nb_workers: int = 0) -> [torch.utils.data.DataLoader, torch.utils.data.DataLoader]:
        """Retourne les chargeurs de données CASIA1
...
class MyCASIA1(VisionDataset):
    ...
    def __init__(self, *args, **kwargs):
        """
        Initializes the MyCASIA1 dataset by calling the parent VisionDataset constructor.
        """
